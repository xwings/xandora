...
-- Dump completed on 2010-12-05 23:48:44
-- MySQL dump 10.13  Distrib 5.1.49, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: xandora
-- ------------------------------------------------------
...
-- Dump completed on 2010-12-05 23:48:45
-- MySQL dump 10.13  Distrib 5.1.49, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: xandora
-- ------------------------------------------------------
...
CREATE TABLE `malwareinfo` (
  ...
  `infection_method` tinyint(3) unsigned NOT NULL COMMENT 'how does this malware propagate',
  `update_method` tinyint(3) unsigned NOT NULL COMMENT 'how does this malware updates itself',
  ...
  CONSTRAINT `malwareinfo_ibfk_2` FOREIGN KEY (`infection_method`) REFERENCES `_infection_method` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `malwareinfo_ibfk_3` FOREIGN KEY (`update_method`) REFERENCES `_update_method` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=20853 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
) ENGINE=InnoDB AUTO_INCREMENT=416999 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
) ENGINE=InnoDB AUTO_INCREMENT=969505 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1967519 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
) ENGINE=InnoDB AUTO_INCREMENT=178438 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
) ENGINE=InnoDB AUTO_INCREMENT=815545 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2010-12-05 23:48:46
-- MySQL dump 10.13  Distrib 5.1.49, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: xandora
-- ------------------------------------------------------
