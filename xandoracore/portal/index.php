...
$query2="SELECT hashsha1, source,fileinfo, score, panda, date, time, score, status  FROM MalwareInfo where 
...
echo "<td  bgcolor='dfdfdf' >&nbsp;<font face='arial,verdana,helvetica' color='#000000' size='4'>Date</font></td>";
echo "<td  bgcolor='dfdfdf' >&nbsp;<font face='arial,verdana,helvetica' color='#000000' size='4'>Time</font></td>";
echo "<td  bgcolor='dfdfdf' >&nbsp;<font face='arial,verdana,helvetica' color='#000000' size='4'>Binary</font></td>";
echo "<td  bgcolor='dfdfdf' >&nbsp;<font face='arial,verdana,helvetica' color='#000000' size='4'>Type</font></td>";
echo "<td  bgcolor='dfdfdf' >&nbsp;<font face='arial,verdana,helvetica' color='#000000' size='4'>Score</font></td>";
echo "<td  bgcolor='dfdfdf' >&nbsp;<font face='arial,verdana,helvetica' color='#000000' size='4'>Sources</font></td>";
echo "<td  bgcolor='dfdfdf'>&nbsp;<font face='arial,verdana,helvetica' color='#000000' size='4'>Status</font></td></tr>";

////////////// Now let us start executing the query with variables $eu and $limit  set at the top of the page///////////
$query="SELECT hashsha1, source,fileinfo, score, panda, date, time, email,pandalabs, panda,  status  FROM MalwareInfo where 
        hashmd5 like '%$searchTermDB%' or email like '%$searchTermDB%' or kav like '%$searchTermDB%' or nod like '%$searchTermDB%' 
...
echo "<td align=left bgcolor=$bgcolor id='title'>&nbsp;<font face='Verdana' size='2'><a href=samples.php?f=$noticia[hashsha1]>$noticia[hashsha1]</a></font></td>"; 
...
{
	echo "<td align=left bgcolor=$bgcolor id='title'>&nbsp;<font face='Verdana' size='2'><a href=http://report.xandora.net/file-analyzer-$noticia[hashsha1] TARGET='_blank'>$noticia[status]</a></font></td>"; 
}
else {echo "<td align=left bgcolor=$bgcolor id='title'>&nbsp;<font face='Verdana' size='2'><TARGET='_blank'>Processing</a></font></td>";}
...
echo "MGM: Malware Generated Malware<br>";
echo "PSCAN: Panda<br>";
echo "<br>Questions? Email to feedback@malwaredatabase.net";
