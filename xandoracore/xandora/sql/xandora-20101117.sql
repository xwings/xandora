...
CREATE TABLE `malwareinfo` (
  ...
  `status` varchar(16) unsigned NOT NULL COMMENT 'processing status, for monitoring',
  PRIMARY KEY (`xid`),
  KEY `ext` (`ext`),
...
--
-- Dumping data for table `malwareinfo`
--

LOCK TABLES `malwareinfo` WRITE;
/*!40000 ALTER TABLE `malwareinfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `malwareinfo` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `registryinfo` (
  ...
  `registry_content` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
LOCK TABLES `registryinfo` WRITE;
/*!40000 ALTER TABLE `registryinfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `registryinfo` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `scaninfo` WRITE;
/*!40000 ALTER TABLE `scaninfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `scaninfo` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2010-11-17 20:04:04
