...
-- Dump completed on 2010-11-28  2:10:21
-- MySQL dump 10.13  Distrib 5.1.49, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: xandora
-- ------------------------------------------------------
...
CREATE TABLE `malwareinfo` (
  ...
  `sha1` varchar(65) COLLATE utf8_unicode_ci NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=139792 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
) ENGINE=InnoDB AUTO_INCREMENT=79505 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
) ENGINE=InnoDB AUTO_INCREMENT=632622 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2010-11-28  2:10:22
